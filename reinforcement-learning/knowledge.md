...
## 一、传统机器人开发的 分层架构（先给全景）
传统移动机器人（服务机器人、巡检机器人）的经典架构可以抽象为：【高层决定做什么，中层决定怎么走，底层负责怎么动】

【任务 / 行为层】   Task Planner / FSM / BT
        ↓
【导航决策层】      Global Planner / Local Planner
        ↓
【感知与建图层】    Perception + SLAM
        ↓
【运动控制层】      Motion Control (Velocity / Trajectory)
        ↓
【机器人本体】      底盘 / 电机 / 执行器
```
| 模块 | 输入 | 输出 | 频率 | 触发条件 |
...
## 二、具体任务拆解：从教室 → 出教室门 → 沿走廊 → 到厕所（途中有人）
