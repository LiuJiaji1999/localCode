...
https://cspaper.org/reviews 常见的期刊和会议（照icme经验来讲，确实很真实，
...
第一阶段-GAN： 像是一个才华横溢但情绪不稳定的天才画家，
    机械地拟合像素的概率分布；
    只理解，“猫”是⼀堆⽑茸茸的像素规律，“⾃⾏⻋”是另⼀堆⾦属质感的像素规律，它不
知道两者之间存在什么物理联系，更⽆法理解“骑”这个动作的含义。
第二阶段-CLIP： 像是拿着地图的向导
...
第三阶段-扩散模型： 像是一个基本功扎实、耐心极致的工匠大师。--雕刻⽯膏
    ...
    在⽣成（推理）阶段，其实就是重演这个“反向过程”。我们会随机拿⼀张全是噪点的“雪花图”给模型，让它运⽤学会的“去噪能⼒”开始⼯作。
